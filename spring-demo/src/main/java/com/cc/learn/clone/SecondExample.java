...
public class SecondExample {
    ...
    static class People {
        ...
        public People(Integer id, String name, SecondExample.Address address) {
            this.id = id;
            this.name = name;
        ...
        public SecondExample.Address getAddress() {
            return address;
        }

        public void setAddress(SecondExample.Address address) {
            this.address = address;
        }
    }
