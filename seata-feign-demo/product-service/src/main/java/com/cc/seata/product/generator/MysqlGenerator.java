package com.cc.seata.product.generator;
...
public class MysqlGenerator {
	...
	public static final String MOUDLE_PATH = "/product-service";
    public static final String DB = "seata_storage";
	public static final String DB_HOST = "localhost";
	public static final int DB_PORT = 3306;
	public static final String DB_USER = "root";
	public static final String DB_PASSWORD = "111111";
	// public static final String BASE_BACKAGE = "com.hp.tiger.bluepgs";
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(PROJECT_PATH +MOUDLE_PATH+ "/src/main/java");
        ...
        dsc.setUrl(String.format("jdbc:mysql://%s:%d/%s?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai", DB_HOST, DB_PORT, DB));
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return PROJECT_PATH + MOUDLE_PATH+"/src/main/resources/mapper/"   + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
